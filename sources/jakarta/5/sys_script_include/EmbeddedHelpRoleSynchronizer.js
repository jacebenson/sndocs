...
EmbeddedHelpRoleSynchronizer.prototype = {
	...
	roleSynchronizer : function () {
		gs.log('Sync EmbeddedHelpRoleSynchronizer in Embedded Help - Insert');
		var roleIDs = '';
		var i = 0;
		...
		gs.log('Sync EmbeddedHelpRoleSynchronizer in Embedded Help ' + newEmbeddedHelpRoleSynchronizers.getEncodedQuery() + ' Encoded Query.' );
		...
		gs.log('Sync EmbeddedHelpRoleSynchronizer in Embedded Help - Inserted ' + newEmbeddedHelpRoleSynchronizers.getRowCount() + ' records.' );
	}
