...
EmailDiagnosticsV2.prototype = {
    ...
    isSendReadyThresholdExceeded: function() {
        return this.sendReadyCount > gs.getProperty('glide.email_diag.threshold.send_ready', 200);
    },

    isSmtpProcessingThresholdExceeded: function() {
        return this.smtpSenderDuration > GlideProperties.getInt('glide.email_diag.threshold.smtp_sender.runtime', 10000);
    },

    isSmsProcessingThresholdExceeded: function() {
        return this.smsSenderDuration > GlideProperties.getInt('glide.email_diag.threshold.sms_sender.runtime', 10000);
    },

    isSmtpLastRunThresholdExceeded: function() {
        return gs.dateDiff(gs.minutesAgo(gs.getProperty('glide.email_diag.threshold.smtp_sender.last_run', 10)), this.smtpSenderLastRun ,true) < 0;
    },

    isSmsLastRunThresholdExceeded: function() {
        return gs.dateDiff(gs.minutesAgo(gs.getProperty('glide.email_diag.threshold.sms_sender.last_run', 10)), this.smsSenderLastRun ,true) < 0;
    },

    isReaderProcessingThresholdExceeded: function() {
        return this.emailReaderDuration > GlideProperties.getInt('glide.email_diag.threshold.email_reader.runtime', 10000);
    },

    isReaderLastRunThresholdExceeded: function() {
        return gs.dateDiff( gs.minutesAgo(gs.getProperty('glide.email_diag.threshold.email_reader.last_run', 10)), this.emailReaderLastRun,true) < 0;
    },
