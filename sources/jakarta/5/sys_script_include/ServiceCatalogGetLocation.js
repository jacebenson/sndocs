...
ServiceCatalogGetLocation.prototype = Object.extendsObject(AbstractAjaxProcessor, {
	...
	retrieveAddress: function() {
		...
		userShippingAddress = this._getAddress(userSysId);

		if (userShippingAddress == '' || userShippingAddress == null) {
				userShippingAddress = this._fetchAddressfromUserTable(userSysId);
		}
