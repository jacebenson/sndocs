...
PwdAjaxVerifyProcessor.prototype = Object.extendsObject(PwdAjaxRequestProcessor, {
	...
	*/
	...
	checkVerification: function() {
		...
		var sysparm_user_input = gs.getSession().getProperty('sysparm_user_input');
		...
		if (isValid)
			...
			return this._handleRetry(sysparm_request_id, sysparm_user_input);
	},
	...
	_handleRetry: function(sysparm_request_id, sysparm_user_input) {		
