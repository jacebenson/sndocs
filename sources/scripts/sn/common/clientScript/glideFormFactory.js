  ...
  function createGlideForm(tableName, sysId, fields, uiActions, options) {
    ...
    function GlideForm() {
      ...
      this.submit = function(submitActionName) {
        ...
        if (!_hasMandatoryFields(this) || _hasError(this) || !_runSubmitScripts()) {
        ...
        var g_form = this;
        return uiAction.execute(this).then(function() {
    ...
    function _hasError(g_form) {
      ...
      var errorFieldMsg = "The following fields contains error:";
