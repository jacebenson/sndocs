...
document.write('<link href="9aaa511a0fb642008a763e4ce1050ef8.cssdbx" rel="stylesheet" type="text/css" /><script type="text/javascript" src="SweetAlerts-min.jsdbx"></script>');
...
/*! RESOURCE: Self Service Switcher UI16 */
addLoadEvent(function() {
  try {
    if (g_user.hasRoles()) {
      var EssIcon = '<a href="./self-service" target="_top" data-original-title="Switch to ESS Portal" aria-describedby="hint"><svg class="icon-view btn btn-icon" id="self-service-switcher-ui16" style="color: rgb(255, 255, 255); border: none; line-height: inherit; margin-right: 10px;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 240 240" enable-background="new 0 0 240 240"><g><g><path fill="#ffffff" d="M199.925,155.5c0,2.33-1.906,4.236-4.236,4.236H44.312c-2.33,0-4.236-1.906-4.236-4.236V44.403c0-2.33,1.906-4.236,4.236-4.236h151.377c2.33,0,4.236,1.906,4.236,4.236V155.5z"></path></g><g><path stroke-width="6.774" stroke="#A5A9AC" fill="none" d="M191.43,146.505c0,2.02-1.651,3.671-3.671,3.671H52.242c-2.019,0-3.671-1.651-3.671-3.671V53.398c0-2.019,1.652-3.671,3.671-3.671h135.517c2.02,0,3.671,1.652,3.671,3.671V146.505z"></path></g><g><path fill="#ffffff" d="M86.049,199.834c-2.33,0-4.236-1.906-4.236-4.236V178.49c0-2.33,1.906-4.236,4.236-4.236h67.902c2.33,0,4.236,1.906,4.236,4.236v17.107c0,2.33-1.906,4.236-4.236,4.236H86.049z"></path></g><g><g><path fill="#ffffff" d="M25.563,133.922c0,2.33-1.906,4.236-4.236,4.236H4.236c-2.33,0-4.236-1.906-4.236-4.236V66.002c0-2.33,1.906-4.236,4.236-4.236h17.091c2.33,0,4.236,1.906,4.236,4.236V133.922z"></path></g><g><path fill="#ffffff" d="M240,133.922c0,2.33-1.906,4.236-4.236,4.236h-17.102c-2.33,0-4.236-1.906-4.236-4.236V66.002c0-2.33,1.906-4.236,4.236-4.236h17.102c2.33,0,4.236,1.906,4.236,4.236V133.922z"></path></g></g></g></svg>';
      var switcherIconUI16 = parent.document.getElementById('self-service-switcher-ui16');
      var switcherIconUI15 = parent.document.getElementById('self-service-switcher-ui15');
      var settingIcon = parent.document.getElementById('nav-settings-button');
      if (!switcherIconUI16 && !switcherIconUI15) {
        var newContainer = document.createElement("DIV");
        newContainer.innerHTML = EssIcon;
        var userProfile = parent.document.getElementsByClassName("navpage-header-content")[0];
        userProfile.insertBefore(newContainer, userProfile.childNodes[0]);
      }
    }
  } catch (e) {}
});
...
/*! RESOURCE: Tech-hub Switcher UI15 */
addLoadEvent(function() {
  try {
    if ($('navpage_header_control_button') && g_user.hasRole('u_tech_hub_analyst')) {
      var TechHubIcon = '<a href="./techhub" target="_top" data-original-title="Switch to Tech-hub Service Portal" aria-describedby="hint"><svg class="icon-view btn btn-icon" id="tsp-switcher-ui15" style="border: none; line-height: inherit; margin-right: 5px;" fill="#ffffff" height="32px" width="32px" enable-background="new 0 0 24 24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M15,18H9c0,0.2,0,0.8,0,1c0,1.7,1.3,2,3,2s3-0.3,3-2C15,18.8,15,18.2,15,18z"/><path d="M13.5,20h-3c0,0.1,0,0.4,0,0.5c0,0.8,0.7,1.5,1.5,1.5s1.5-0.7,1.5-1.5C13.5,20.4,13.5,20.1,13.5,20z"/><path d="M19,9c0-3.9-3.2-7.1-7.1-7C8.2,2.1,5.1,5.1,5,8.7c-0.1,2.4,1,4.6,2.8,5.9C8.6,15.2,9,16.1,9,17v0h6v0c0-0.9,0.4-1.8,1.1-2.4  C17.9,13.4,19,11.3,19,9z"/></svg></a>';
      $('gsft_logout').insert({
        Before: TechHubIcon
      });
    }
...
/*! RESOURCE: Tech-hub Switcher UI16 */
addLoadEvent(function() {
  try {
    if (g_user.hasRole('u_tech_hub_analyst')) {
      var TechHubIcon = '<a href="./techhub" target="_top" data-original-title="Switch to Tech-hub Service Portal" aria-describedby="hint"><svg class="icon-view btn btn-icon" id="tsp-switcher-ui16" style="border: none; line-height: inherit; margin-right: 5px;" fill="#ffffff" height="32px" width="32px" enable-background="new 0 0 24 24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M15,18H9c0,0.2,0,0.8,0,1c0,1.7,1.3,2,3,2s3-0.3,3-2C15,18.8,15,18.2,15,18z"/><path d="M13.5,20h-3c0,0.1,0,0.4,0,0.5c0,0.8,0.7,1.5,1.5,1.5s1.5-0.7,1.5-1.5C13.5,20.4,13.5,20.1,13.5,20z"/><path d="M19,9c0-3.9-3.2-7.1-7.1-7C8.2,2.1,5.1,5.1,5,8.7c-0.1,2.4,1,4.6,2.8,5.9C8.6,15.2,9,16.1,9,17v0h6v0c0-0.9,0.4-1.8,1.1-2.4  C17.9,13.4,19,11.3,19,9z"/></svg></a>';
      var tspSwitcherIconUI16 = parent.document.getElementById('tsp-switcher-ui16');
      var tspSwitcherIconUI15 = parent.document.getElementById('tsp-switcher-ui15');
      var tspSettingIcon = parent.document.getElementById('nav-settings-button');
      if (!tspSwitcherIconUI16 && !tspSwitcherIconUI15) {
        var newContainer = document.createElement("DIV");
        newContainer.innerHTML = TechHubIcon;
        var userProfile = parent.document.getElementsByClassName("navpage-header-content")[0];
        userProfile.insertBefore(newContainer, userProfile.childNodes[0]);
      }
    }
...
/*! RESOURCE: CompareDates2 */
function compareDates2(date1, format1, date2, format2) {
  if (!isDate(date1, format1) || !isDate(date2, format2))
    return '-1';
  var startDate = getDateFromFormat(date1, format1);
  var endDate = getDateFromFormat(date2, format2);
...
/*! RESOURCE: Self Service Switcher UI15 */
addLoadEvent(function() {
  try {
    if ($('navpage_header_control_button') && g_user.hasRoles()) {
      var EssIcon = '<a href="./self-service" target="_top" data-original-title="Switch to ESS Portal" aria-describedby="hint"><svg class="icon-view btn btn-icon" id="self-service-switcher-ui15" style="color: rgb(255, 255, 255); border: none; line-height: inherit; margin-right: 10px;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 240 240" enable-background="new 0 0 240 240"><g><g><path fill="#ffffff" d="M199.925,155.5c0,2.33-1.906,4.236-4.236,4.236H44.312c-2.33,0-4.236-1.906-4.236-4.236V44.403c0-2.33,1.906-4.236,4.236-4.236h151.377c2.33,0,4.236,1.906,4.236,4.236V155.5z"></path></g><g><path stroke-width="6.774" stroke="#A5A9AC" fill="none" d="M191.43,146.505c0,2.02-1.651,3.671-3.671,3.671H52.242c-2.019,0-3.671-1.651-3.671-3.671V53.398c0-2.019,1.652-3.671,3.671-3.671h135.517c2.02,0,3.671,1.652,3.671,3.671V146.505z"></path></g><g><path fill="#ffffff" d="M86.049,199.834c-2.33,0-4.236-1.906-4.236-4.236V178.49c0-2.33,1.906-4.236,4.236-4.236h67.902c2.33,0,4.236,1.906,4.236,4.236v17.107c0,2.33-1.906,4.236-4.236,4.236H86.049z"></path></g><g><g><path fill="#ffffff" d="M25.563,133.922c0,2.33-1.906,4.236-4.236,4.236H4.236c-2.33,0-4.236-1.906-4.236-4.236V66.002c0-2.33,1.906-4.236,4.236-4.236h17.091c2.33,0,4.236,1.906,4.236,4.236V133.922z"></path></g><g><path fill="#ffffff" d="M240,133.922c0,2.33-1.906,4.236-4.236,4.236h-17.102c-2.33,0-4.236-1.906-4.236-4.236V66.002c0-2.33,1.906-4.236,4.236-4.236h17.102c2.33,0,4.236,1.906,4.236,4.236V133.922z"></path></g></g></g></svg></a>';
      $('gsft_logout').insert({
        Before: EssIcon
      });
    }
...
/*! RESOURCE: custom-login-rules */
(function() {
  if ((window.location.toString().toLowerCase().indexOf('lennar') > -1 || window.location.toString().toLowerCase().indexOf('eaglehm') > -1) && (window.location.pathname.toString().indexOf('navpage') > -1 || window.location.pathname == '/')) {
    var gaRedirectUser = new GlideAjax('UserRedirectionHelper');
    gaRedirectUser.addParam('sysparm_name', 'getUserValues');
    gaRedirectUser.getXML(function(response) {
      var userResponse = response.responseXML.getElementsByTagName('userSessionObj');
      var resUserName = '';
      var resCompany = '';
      var resTitle = '';
      var resEmail = '';
      var resNumberOfRoles = 0;
      var resInvalidUserRolesNumber = 0;
      for (var i = 0; i < userResponse.length; i++) {
        var name = userResponse[i].getAttribute('name');
        var value = userResponse[i].getAttribute('value');
        if (name == 'name') {
          resUserName = value;
          ...
          resEmail = value;
        } else if (name == 'numberOfRoles') {
          resNumberOfRoles = value;
        } else if (name == 'invalidUserRolesNumber') {
          resInvalidUserRolesNumber = value;
        }
      }
      if (resNumberOfRoles == 0 || resInvalidUserRolesNumber == 0) {
        var redLoc = document.getElementById('gsft_main').src;
        redLoc = redLoc.toString();
        if (redLoc.indexOf('home_splash') < 0) {
          if (redLoc.indexOf('lennardev') > -1) {
            redLoc = redLoc.replace('https://lennardev.service-now.com/', '');
          } else if (redLoc.indexOf('lennartest') > -1) {
            redLoc = redLoc.replace('https://lennartest.service-now.com/', '');
          } else if (redLoc.indexOf('lennarqa') > -1) {
            redLoc = redLoc.replace('https://lennarqa.service-now.com/', '');
          } else if (redLoc.indexOf('lennartraining') > -1) {
            redLoc = redLoc.replace('https://lennartraining.service-now.com/', '');
          } else if (redLoc.indexOf('eaglehmdev') > -1) {
            redLoc = redLoc.replace('https://eaglehmdev.service-now.com/', '');
          } else if (redLoc.indexOf('eaglehmtest') > -1) {
            redLoc = redLoc.replace('https://eaglehmtest.service-now.com/', '');
          } else {
            redLoc = redLoc.replace('https://lennar.service-now.com/', '');
          }
          window.location = "./self-service/self-service-router?uri=" + redLoc;
        } else {
          window.location = "./self-service";
        }
      }
    });
  }
})();
/*! RESOURCE: Hide Collaborate Icon */
addLoadEvent(function() {
  try {
    var collaborateUI15 = document.getElementById("connect-toggle-button");
    var collaborateUI16 = parent.document.getElementById("connect_toggle_sidebar_header_button");
    if (collaborateUI15) {
      document.getElementById("connect-toggle-button").style.display = "none";
    } else if (collaborateUI16) {
      parent.document.getElementById("connect_toggle_sidebar_header_button").style.display = "none";
    }
  } catch (e) {}
});
