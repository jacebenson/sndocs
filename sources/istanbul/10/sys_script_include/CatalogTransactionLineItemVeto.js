...
CatalogTransactionLineItemVeto.prototype =  Object.extendsObject(AbstractTransaction, {
   ...
   _veto : function(gr) {
       ...
       gr.setValue("state", 4);
       gr.update();
       gs.getSession().addInfoMessage(gs.getMessage("Request Item " + gr.number + " has been cancelled"));
   },
   ...
   _accept : function(gr) {
       ...
       gr.update();
       gs.getSession().addInfoMessage(gs.getMessage("Request Item " + gr.number + " has been accepted"));
   }
});