  ...
  return {
    ...
    controller: function($scope) {
      ...
      function initGlideForm() {
        ...
        g_form = glideFormFactory.create($scope, (isCatalogItem ? "" : formModel.table), formModel.sys_id, flatFields, uiActions, {
      ...
      function messageView(formModel) {
      ...
      function init() {
        ...
        messageView(formModel);
        flatFields = getFieldsFromView(formModel);
        isCatalogItem = hasCatalogVariable(flatFields);
        $scope.containers = formModel._sections;
        extendFields(formModel._fields);
        initGlideForm();
      }
