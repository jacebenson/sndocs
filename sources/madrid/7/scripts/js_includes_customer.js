...
ready(function() {
  ...
  script.setAttribute('src', 'sweetAlert.min.jsdbx');
  script.setAttribute('type', 'text/javascript');
  var ieScript = document.createElement('script');
  ieScript.setAttribute('src', 'https://cdn.jsdelivr.net/npm/promise-polyfill@8/dist/polyfill.js');
  ieScript.setAttribute('type', 'text/javascript');
