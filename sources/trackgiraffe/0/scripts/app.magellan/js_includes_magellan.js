...
angular.module('Magellan').controller('MagellanCtrl',
  function(
    ...
    $scope.setNavigatingState = function(state) {
      top.NOW.megellan && top.NOW.megellan.setNavigatingState && top.NOW.magellan.setNavigatingState(state);
    };
          ...
          _contactContainers: function(t) {
              ...
              if (c)
                if (1 === this.containers.length) this.containers[p].containerCache.over || (this.containers[p]._trigger("over", t, this._uiHash(this)), this.containers[p].containerCache.over = 1);
                  ...
                  n ? this._rearrange(t, n, null, !0) : this._rearrange(t, null, this.containers[p].element, !0), t