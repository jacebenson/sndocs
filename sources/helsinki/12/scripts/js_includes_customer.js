...
function disableOption(fieldName, choiceValue) {
  ...
  if (control && !control.options) {
    ...
    control = g_form.getElement(name);
  }
  if (!control)
    return;
  if (!control.options)
...
/*! RESOURCE: DynamicTagManager */
var urlPath = window.location.pathname;
if (window.location.href.indexOf('medtronicprod.service-now.com') > 0) {
  if (urlPath.indexOf('it') > -1) {
    document.writeln('<script src="//assets.adobedtm.com/ce8746a9125c5b45bcf05e12f84658c0c6ff5b9a/satelliteLib-7d0f14ff30f0882c93bd4cba704a26d353e4e77c.js"></script>');
  } else if (urlPath.indexOf('hr') > -1) {
    document.writeln('<script src="//assets.adobedtm.com/ce8746a9125c5b45bcf05e12f84658c0c6ff5b9a/satelliteLib-2502587afb3cbc8302b7172b92feec3a24eeca41.js"></script>');
  }
} else {
  if (urlPath.indexOf('it') > -1) {
    document.writeln('<script src="//assets.adobedtm.com/ce8746a9125c5b45bcf05e12f84658c0c6ff5b9a/satelliteLib-7d0f14ff30f0882c93bd4cba704a26d353e4e77c-staging.js"></script>');
  } else if (urlPath.indexOf('hr') > -1) {
    document.writeln('<script src="//assets.adobedtm.com/ce8746a9125c5b45bcf05e12f84658c0c6ff5b9a/satelliteLib-2502587afb3cbc8302b7172b92feec3a24eeca41-staging.js"></script>');
  }
}
if (urlPath.indexOf('hr') > -1 || urlPath.indexOf('it') > -1) {
  window.onload = function() {
    var script = document.createElement('script');
    script.type = 'text/javascript';
    script.text = '_satellite.pageBottom();';
    document.body.appendChild(script);
  };
}
/*! RESOURCE: Font-Awesome */
document.writeln('<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">');
