...
GuidedSetupUsageAnalyticsSNC.prototype = {
	...
	initialize: function() {
		...
		this.ATTR_UA_SYS_CLASS_NAME = this.gswUtil.ATTR_SYS_CLASS_NAME;
	...
	sendDataToAnalytics: function(changeLogGr) {
		...
		if (type == this.gswUtil.LOG_TYPE.COMPLETED || type == this.gswUtil.LOG_TYPE.VISITED) {
		...
		if (type == this.gswUtil.LOG_TYPE.COMPLETED || type == this.gswUtil.LOG_TYPE.UNCOMPLETED || type == this.gswUtil.LOG_TYPE.DEACTIVATED || type == this.gswUtil.LOG_TYPE.REACTIVATED || isBegin) {
			...
			if (type == this.gswUtil.LOG_TYPE.COMPLETED) {
	...
	_setCommonAttributes: function(changeLogGr) {
		...
		if (contentGr) {
			...
			this.data[this.ATTR_UA_SYS_CLASS_NAME] = contentGr.getValue(this.gswUtil.ATTR_SYS_CLASS_NAME);
	...
	_setCompletedAttributes: function(changeLogGr, beginGr) {
		...
		if (this.data[this.ATTR_UA_SYS_CLASS_NAME] == this.gswUtil.TABLE_CONTENT_INFORMATION) {
