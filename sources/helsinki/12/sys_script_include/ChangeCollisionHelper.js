...
/**
 * Checks if the time span defined by startDate and endDate falls wholly in the
 ...
 * @return boolean
 */
ChangeCollisionHelper.isDateInCiMaintenanceWindows = function(startDate, endDate, maintenanceWindow) {
