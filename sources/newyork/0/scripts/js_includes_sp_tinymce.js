              ...
              w || (N = !0, w = function() {
                  ...
                  if (!m(e) && (t || e.keyCode == ee)) {
                    ...
                    if (!m(t) && !x.isCollapsed() && t.charCode > 31 && !e.metaKeyPressed(t)) {
                      ...
                      }), a.appendChild(f.getDoc().createTextNode(s)), o = C.getParent(n.startContainer, C.isBlock), C.isEmpty(o) ? Z(o).empty().append(i) : n.insertNode(i), n.setStart(a.firstChild, 1), n.setEnd(a.firstChild, 1), f.selection.setRng(n)) : f.s