  ...
  function($window, $scope, $http) {
    ...
    $scope.cloneHomepage = function() {
      $http(getHttpParams('get', {
        ...
        if (data && data.hasMultipleDashboards) {
        ...
        } else if (data && !data.hasMultipleDashboards) {
    ...
    function fireErrorMsg() {
      var span = document.createElement('span');
      span.setAttribute('data-type', 'error');
      span.setAttribute('data-text', 'An error has occurred while processing your request. Please try again.');
      span.setAttribute('data-duration', '10000');
