...
AssessmentUtilsAJAX.prototype = Object.extendsObject(AbstractAjaxProcessor, {
	...
	iterateAssessmentInstance:function() { 
		...
		instance.query(); 
		instance.next(); 
		var url = 'assessment_take2.do?sys_id=' + instance.getValue('sys_id') + '&sysparm_assessable_sysid=' + instance.getValue('sys_id') + '&sysparm_assessable_type=undefined' + '&sysparm_reader_view=true&sysparm_record_list=' + query + '&sysparm_record_row=' + currentRow + '&sysparm_record_rows='+ totalRows +'&sysparm_record_target=asmt_assessment_instance&sysparm_view='+view+'&sysparm_instance=true'; 
		gs.setRedirect(url); 
	},
