...
GlideConditionRow.prototype = {
    ...
    getAndButtonHTML: function(onClick) {
        return "<button onclick=\"" + onClick + "\" title='" + this.answer['Add AND Condition'] + "' alt='" + this.answer['Add AND Condition'] + "' class='btn btn-default filerTableAction'>" + this.answer['and'].