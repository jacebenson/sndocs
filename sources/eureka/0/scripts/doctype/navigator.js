...
$j(function($) {
  ...
  function switchCheckedState(checked) {
    var t = $("DIV.nav-wrapper");
    t.children("input[type=checkbox]:not(#perspectives)").each(function() {
  ...
  document.on('click', 'img.section_toggle, span.section_toggle', function(evt, element) {
    ...
    if (ex)
      ...
      img.src = img.getAttribute('data-collapsed')
    setPreference("collapse.section." + id, new String(!ex));
  })
