...
function buildFieldsPerType(tableName, tr, descriptorName, fOper, fValue, includeExtended, tableNameFull, filterClass) {
  ...
  var showDynamicReferenceOperator = shouldShowDynamicReferenceOperator(type, elementDef, tableNameFull);
...
function shouldShowDynamicReferenceOperator(type, elementDef, tableNameFull) {
