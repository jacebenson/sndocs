...
a.lang=x("moment.lang is deprecated. Use moment.locale instead.",$a),a.langData=x("moment.langData is deprecated. Use moment.localeData instead.",bb);var Ze=Math.abs,$e=ed("ms"),_e=ed("s"),af=ed("m"),bf=ed("h"),cf=ed("d"),df=ed("w"),ef=ed("M"),ff=ed("y"),gf=gd("milliseconds"),hf=gd("seconds"),jf=gd("minutes"),kf=gd("hours"),lf=gd("days"),mf=gd("months"),nf=gd("years"),of=Math.round,pf={s:45,
m:45,
h:22,
d:26,
...
/*! RESOURCE: HISPSearchResultEntry */
(function () {
var moduleName = 'sn.hisp.searchEntyResult';
var DEFAULT_ID = '__default';
angular.module(moduleName, []).directive('snSearchResult', function() {
return {
template: "Hello custom directive"
};
});
})();
...
$j('#sectionIframe').parent().css({"margin-top": '', "margin": "10px auto", "width": "95%"});
} else {
$j('#sectionIframe').parent().css({"margin": "", "margin-top": "10px", "width": "100%"});
}
}
